...
test('different combat behaviors retain different phase composition',()=>{
 ...
 assert.equal(projectile.travel,'moves/hydroPump');assert.equal(melee.impact,PXG_MOVE_VFX.iceFang.impact);
