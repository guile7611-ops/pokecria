...
export class Discovery {
 constructor(map, saved=[]){this.map=map;this.size=8;this.cols=Math.ceil(map.cols/8);this.rows=Math.ceil(map.rows/8);this.seen=new Set(saved.filter(n=>Number.isInteger(n)&&n>=0&&n<this.cols*this.rows));this.current=new Set();this.last='';}
