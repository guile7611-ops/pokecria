...
const BaseRare=new Set(['abra','gastly','magnemite','voltorb','cubone','murkrow','larvitar','torkoal','bulbasaur','charmander','squirtle','chikorita','cyndaquil','totodile','treecko','torchic','mudkip']);
