...
export const RegionDefinitions = [
  ...
  region('vulcao','Caldeira Rubra','volcano',387,205,46,32,[40,70],['slugma','magcargo','geodude','graveler','cubone','marowak','numel','camerupt','torkoal','houndour','houndoom'],'Fragmento de brasa'),
